...
bulan =st.selectbox("BULAN:", list_bulan, index='August', on_change=reset_button_state)
...
df_tab = df[(df['Bulan'] == bulan) & ( (df['Nama Cabang'].str.startswith('2')) | (df['Nama Cabang'].str.startswith('5')))]
